                            ...
                            <div className="card-body p-4 p-md-5">
                              <div className="row align-items-center">
                                ...
                                <div className="col-md-10">
                                  ...
                                  {/* Expandable Content */}
                                  <div
                                    className={`expandable-content ${showFullOverview ? "expanded" : ""
                                      }`}
                                  >
                                    <p className="description-text mb-3">
                                      Already named{" "}
                ...
                <div className="details-media-container">
                  ...
                  <div className="details-section">
                    ...
                    <div className="tab-buttons">
                      <button
                        className={`tab-button ${activeDetailsTab === "workouts" ? "active" : ""
                          }`}
                      ...
                      <button
                        className={`tab-button ${activeDetailsTab === "results" ? "active" : ""
                          }`}
                          ...
                          >
                            {getVisibleImages().map((src, index) => (
                              ...
                              >
                                <img
                                  src={src}
                                  alt={`Trust But Verify ${currentMediaIndex + index + 1
                                    }`}
                                  loading="lazy"
                                />
                          ...
                          <div className="media-indicators">
                            ...
                            <div className="media-page-dots">
                              {Array.from({ length: totalPages }, (_, index) => (
                                <button
                                  key={index}
                                  className={`media-page-dot ${currentPage === index + 1 ? "active" : ""
                                    }`}
                          ...
                          <div className="main-content">
                            ...
                            <div className="creative-accordion">
                              {accordionData.map((item) => (
                                <div
                                  key={item.key}
                                  className={`accordion-card ${activeAccordion === item.key ? "active" : ""
                                    }`}
                                >
                                  <button
                                  ...
                                  <div
                                    className={`accordion-content ${activeAccordion === item.key ? "show" : ""
                                      }`}
                                  >
                                    {item.content}
                                  </div>
